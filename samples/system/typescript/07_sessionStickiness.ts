...
async function main(): Promise<void> {
  ...
  console.log(`         Reply : ${responseA1.choices[0].message?.content}\n`);
  ...
  const responseA2 = (await client.chat.completions.create({
    ...
    messages: [
      { role: "user", content: "Hi! My name is Alice. Remember it." },
      { role: "assistant", content: responseA1.choices[0].message?.content ?? "" },
  ...
  console.log(`         Reply : ${responseA2.choices[0].message?.content}\n`);
  ...
  const responseA3 = (await client.chat.completions.create({
    ...
    messages: [
      ...
      { role: "assistant", content: responseA1.choices[0].message?.content ?? "" },
      { role: "user", content: "What is my name?" },
      { role: "assistant", content: responseA2.choices[0].message?.content ?? "" },
  ...
  console.log(`         Reply : ${responseA3.choices[0].message?.content}\n`);
  ...
  console.log(`         Reply : ${responseB1.choices[0].message?.content}\n`);
